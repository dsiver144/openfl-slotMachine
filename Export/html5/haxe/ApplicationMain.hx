...
@:dox(hide) class ApplicationMain {
	...
	public static function main () {
		...
		lime.system.System.__registerEntryPoint ("DsiSlotMachine", create);
		
		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed ("DsiSlotMachine", null, 0, 0);
		#end
		#else
		create (null);
		#end
	...
	public static function create (config):Void {
		...
		app.meta["file"] = "DsiSlotMachine";
		app.meta["name"] = "DsiSlotMachine";
		app.meta["packageName"] = "com.sample.dsislotmachine";
